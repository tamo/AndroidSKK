...
- 画面左右端からの「戻る」ジェスチャーに対応
- ▽モードでもカーソル移動可能
- 表示フォントを少しだけ変更できる (ゴシック、明朝、等幅) *New!*
- 背景画像を設定できる *New!*
...
- Google 辞書で簡易的に意味を確認できる
- あいまい変換を有効にすると近隣キーの押し間違いを考慮して補完 *New!*
- 左フリックで Ctrl、右フリックで Alt のショートカットを使える *New!*
